...
export const PORTFOLIO_DATA = {
  profile: {
    ...
    sub: "Perception systems that see, feel, and reconstruct the world in real time — visuo-tactile SLAM on 3D Gaussian Splatting maps, and the open-source tools that make the stack verifiable and fast.",
    meta: [
  ...
  research: [
    ...
    },
    {
      ...
      links: [{ label: "Paper (PDF)", href: "assets/docs/PoP_SLAM_Paper.pdf" }],
    },
    {
      id: "gnss-denied",
      compact: true,
  ...
  software: [
    ...
    },
    {
      ...
      stats: [
        ...
        { value: "12", label: "per-model adapters: TRELLIS · Hunyuan3D · SAM 3D" },
      ],
      links: [
  ...
  documents: [
    ...
    { title: "PoP-SLAM paper", href: "assets/docs/PoP_SLAM_Paper.pdf" },
    { title: "Capstone award", href: "assets/docs/Capstone.pdf" },
    { title: "K-MOOC robotics certificate", href: "assets/docs/KMOOC_Robotics_Certificate.pdf" },
    { title: "GRE report (ETS-verified)", href: "assets/docs/GRE_Report.pdf" },
  ],
  ...
  archive: [
    ...
    { title: "Beetle-Bot combat robot", date: "2021", note: "3rd place, Villanova mechatronics. Four-person scratch build." },
    { title: "Wi-Fi drone + swarm coordination", date: "2021", note: "Custom stability firmware; multi-drone sync experiments." },
